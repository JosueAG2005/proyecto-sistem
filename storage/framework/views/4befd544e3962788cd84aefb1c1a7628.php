                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="<?php echo e(old('edad_anos', 0)); ?>" 
                                               min="0" 
                                               max="25" 
                                               required>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="edad_meses" 
                                               class="form-control text-center" 
                                               value="<?php echo e(old('edad_meses', 0)); ?>" 
                                               min="0" 
                                               max="11" 
                                               required>
                                        <div class="input-group-append">
                        ...
                        <div class="form-group mb-3" id="cantidad_leche_group" style="display: none;">
                            <label for="cantidad_leche_dia" class="font-weight-bold">Cantidad de Leche por Día (litros)</label>
                            <div class="input-group">
                                <input type="number" 
                                       name="cantidad_leche_dia" 
                                       id="cantidad_leche_dia" 
                                       class="form-control" 
                                       step="0.01" 
                                       min="0" 
                                       value="<?php echo e(old('cantidad_leche_dia')); ?>"
                                       placeholder="Ej: 15.5">
                                <div class="input-group-append">
                                    <span class="input-group-text">litros/día</span>
                                </div>
                            </div>
                            <small class="form-text text-muted">Ingrese la producción diaria de leche (solo para hembras en producción)</small>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group mb-3">
                            <label for="tipo_peso_id" class="font-weight-bold">Método de Venta / Tipo de Peso *</label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" 
                                       ...
                                       step="0.01" 
                                       min="0" 
                                       value="<?php echo e(old('peso_actual')); ?>"
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control" rows="4" placeholder="Describa las características del animal..."><?php echo e(old('descripcion')); ?></textarea>
                        </div>
                    </div>
                </div>
