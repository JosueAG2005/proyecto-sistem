...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6 info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->raza->nombre ?? 'No especificada'); ?></strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->edad ?? '—'); ?> meses</strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->tipoPeso->nombre ?? '—'); ?></strong>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e(number_format($ganado->peso_actual, 2)); ?> KG</strong>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        <div class="col-md-6 info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->tipoAnimal->nombre ?? '—'); ?></strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->sexo ?? '—'); ?></strong>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($ganado->descripcion): ?>
                        <div class="mt-2 pt-2 border-top">
                            ...
                            <p class="mb-0 info-value"><?php echo e($ganado->descripcion); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->vacuna); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->tratamiento); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->medicamento); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e(\Carbon\Carbon::parse($ganado->datoSanitario->fecha_aplicacion)->format('d/m/Y')); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e(\Carbon\Carbon::parse($ganado->datoSanitario->proxima_fecha)->format('d/m/Y')); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->veterinario); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-12 info-row-item">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-0 info-value"><?php echo e($ganado->datoSanitario->observaciones); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
            ...
            <?php if($ganado->datoSanitario && $ganado->datoSanitario->certificado_imagen): ?>
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
            ...
            <?php if($ganado->datoSanitario && $ganado->datoSanitario->certificado_campeon_imagen): ?>
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                ...
                <div class="card-body">
                    <div class="btn-inline-img">
                        <a href="<?php echo e(asset('storage/'.$ganado->datoSanitario->certificado_campeon_imagen)); ?>" 
                           target="_blank" 
                           class="btn btn-success btn-sm">
                            <i class="fas fa-trophy"></i> Ver Certificado Campeón
                        </a>
                        <img src="<?php echo e(asset('storage/'.$ganado->datoSanitario->certificado_campeon_imagen)); ?>" 
                             alt="Certificado Campeón" 
                             class="img-thumbnail img-preview-inline" 
                             style="max-width: 120px; max-height: 80px; cursor: pointer; object-fit: cover;"
                             onclick="window.open('<?php echo e(asset('storage/'.$ganado->datoSanitario->certificado_campeon_imagen)); ?>', '_blank')"
                             title="Click para ver imagen completa">
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php if(count($logrosBelleza) > 0): ?>
                            <div class="col-md-6 info-row-item">
                                <small class="text-muted d-block mb-1 section-title">
                                    <i class="fas fa-star text-warning"></i> Belleza y Ganadería
                                </small>
                                <?php $__currentLoopData = $logrosBelleza; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-1">
                                        <i class="fas fa-trophy text-warning"></i> 
                                        <span class="info-value"><?php echo e($logro); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php endif; ?>
                        <?php if(count($logrosLeche) > 0): ?>
                            <div class="col-md-6 info-row-item">
                                <small class="text-muted d-block mb-1 section-title">
                                    <i class="fas fa-tint text-info"></i> Producción de Leche
                                </small>
                                <?php $__currentLoopData = $logrosLeche; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-1">
                                        <i class="fas fa-trophy text-warning"></i> 
                                        <span class="info-value"><?php echo e($logro); ?></span>
                                    </div>
                        ...
                        <?php endif; ?>
                        <?php if(count($logrosCarne) > 0): ?>
                            <div class="col-md-6 info-row-item">
                                <small class="text-muted d-block mb-1 section-title">
                                    <i class="fas fa-drumstick-bite text-danger"></i> Producción de Carne
                                </small>
                                <?php $__currentLoopData = $logrosCarne; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-1">
                                        <i class="fas fa-trophy text-warning"></i> 
                                        <span class="info-value"><?php echo e($logro); ?></span>
                                    </div>
                        ...
                        <?php endif; ?>
                        <?php if(count($logrosReproduccion) > 0): ?>
                            <div class="col-md-6 info-row-item">
                                <small class="text-muted d-block mb-1 section-title">
                                    <i class="fas fa-heart text-danger"></i> Reproducción
                                </small>
                                <?php $__currentLoopData = $logrosReproduccion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-1">
                                        <i class="fas fa-trophy text-warning"></i> 
                                        <span class="info-value"><?php echo e($logro); ?></span>
                                    </div>
            ...
            <?php if($ganado->datoSanitario && $ganado->datoSanitario->arbol_genealogico): ?>
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                ...
                <div class="card-body">
                    <a href="<?php echo e(asset('storage/'.$ganado->datoSanitario->arbol_genealogico)); ?>" 
                       target="_blank" 
                       class="btn btn-success btn-sm">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0 mb-3 border-left border-success" style="border-left-width: 4px !important;">
                <div class="card-body p-3">
                    <h2 class="h5 mb-2 text-dark"><?php echo e($ganado->nombre); ?></h2>
                ...
                <div class="card-body">
                    <?php if($ganado->fecha_publicacion): ?>
                        <div>
                            ...
                            <strong class="info-value"><?php echo e(\Carbon\Carbon::parse($ganado->fecha_publicacion)->format('d/m/Y')); ?></strong>
                        </div>
                    <?php else: ?>
            ...
            <div class="card shadow-sm border-0 border-success" style="border-width: 3px !important;">
                ...
                <div class="card-body">
                    <div class="info-row-item">
                        <h6 class="mb-1 font-weight-bold text-dark"><?php echo e($ganado->user->name); ?></h6>
                    ...
                    <div class="border-top pt-2">
                        <?php if($ganado->user->role): ?>
                            <div class="info-row-item">
                                ...
                                ?>
                                <span class="badge <?php echo e($badgeClass); ?> badge-lg">
            ...
            <?php if($ganado->datoSanitario && ($ganado->datoSanitario->marca_ganado || $ganado->datoSanitario->senal_numero || $ganado->datoSanitario->marca_ganado_foto)): ?>
            <div class="card shadow-sm border-0 mb-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                            ...
                            <div class="col-12 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->marca_ganado); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="col-12 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->senal_numero); ?></strong>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
            ...
            <?php if($ganado->datoSanitario && ($ganado->datoSanitario->nombre_dueño || $ganado->datoSanitario->carnet_dueño_foto)): ?>
            <div class="card shadow-sm border-0 mb-3">
                        ...
                        <div class="info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->datoSanitario->nombre_dueño); ?></strong>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value"><?php echo e($ganado->ciudad ?? $ganado->municipio ?? 'No disponible'); ?></strong>
                                </div>
                            </div>
                        </div>
                        <div class="info-row-item">
                            ...
                            ?>
                            <strong class="info-value"><?php echo e($direccionCompleta); ?></strong>
                        </div>
                    <?php elseif($ganado->ubicacion): ?>
                        <div class="info-row-item">
                            <i class="fas fa-location-dot text-danger info-icon"></i>
                            <strong class="info-value"><?php echo e($ganado->ubicacion); ?></strong>
                        </div>
                    <?php else: ?>
