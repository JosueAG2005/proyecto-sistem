              ...
              <a href="<?php echo e(route('maquinarias.show', $maquinaria->id)); ?>" class="text-decoration-none" style="color: inherit;">
                <div class="card h-100 ganado-card shadow-lg rounded-lg border-success border-3 overflow-hidden maquinaria-card-wrapper" style="cursor: pointer;">
                  ...
                  <?php if($maquinaria->estadoMaquinaria): ?>
                    <div class="estado-cinta <?php echo e($estadoNombre); ?>">
                  ...
                  <div class="card-body p-3">
                    ...
                    <ul class="ad-meta list-unstyled mb-2">
                      ...
                      <?php if($maquinaria->created_at): ?>
                        <li class="mb-1"><i class="fas fa-calendar-alt text-success"></i> <span class="small">Publicado: <?php echo e(\Carbon\Carbon::parse($maquinaria->created_at)->format('d/m/Y')); ?></span></li>
                      <?php endif; ?>
                    </ul>
                    <div class="mb-2">
                      <span class="badge badge-success badge-lg px-3 py-2 shadow-sm">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="<?php echo e(route('organicos.show', $organico->id)); ?>" class="text-decoration-none" style="color: inherit;">
                <div class="card h-100 ganado-card shadow-lg rounded-lg border-success border-3 overflow-hidden" style="cursor: pointer;">
                  ...
                  <div class="card-body p-3">
                    <h5 class="card-title font-weight-bold text-dark mb-2" style="font-size: 1.1rem; line-height: 1.3;">
                      <i class="fas fa-leaf text-success mr-1"></i><?php echo e($organico->nombre ?? 'Orgánico'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\Proyecto-Mercado-Agricola-main\Proyecto-Mercado-Agricola-main\resources\views/public/ads/index.blade.php ENDPATH**/ ?>