    ...
    <div class="row">
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value">{{ $maquinaria->tipoMaquinaria->nombre }}</strong>
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value">{{ $maquinaria->marcaMaquinaria->nombre }}</strong>
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value">{{ $maquinaria->modelo }}</strong>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @if($maquinaria->estadoMaquinaria)
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    @endphp
                                    <div class="info-icon {{ $iconColor }}">
                                        <i class="fas fa-check-circle"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <small class="text-muted d-block mb-0 section-title">Estado</small>
                                        <strong class="d-block info-value">{{ $maquinaria->estadoMaquinaria->nombre }}</strong>
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="col-md-6 info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="d-block info-value">{{ $maquinaria->categoria->nombre }}</strong>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mt-3 pt-3 border-top">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-0 info-value" style="line-height: 1.7;">{{ $maquinaria->descripcion }}</p>
                                </div>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="d-block info-value">{{ $maquinaria->ciudad ?? $maquinaria->municipio ?? 'No disponible' }}</strong>
                                </div>
                            </div>
                        </div>
                        <div class="info-row-item">
                    ...
                    @elseif($maquinaria->ubicacion)
                        <div class="info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <strong class="info-value">{{ $maquinaria->ubicacion }}</strong>
                                </div>
                            </div>
                        </div>
                    @else
        ...
        <div class="col-lg-4">
            ...
            <div class="price-panel mb-4">
                <h2 class="h4 mb-3 text-dark font-weight-bold">{{ $maquinaria->nombre }}</h2>
                
                <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                    @if($maquinaria->categoria)
                        <span class="badge badge-success badge-modern">
                            <i class="fas fa-tag mr-1"></i> {{ $maquinaria->categoria->nombre }}
                        </span>
                    @endif
                    @if($maquinaria->tipoMaquinaria)
                    ...
                    @if($maquinaria->estadoMaquinaria)
                        ...
                        <span class="badge {{ $badgeClass }} badge-modern">
                            <i class="fas fa-check-circle mr-1"></i> {{ $maquinaria->estadoMaquinaria->nombre }}
                        </span>
                    @endif
                </div>
                ...
                @if($maquinaria->precio_dia)
                    <div class="price-display">
                        ...
                        <h3 class="mb-0">
                            <i class="fas fa-boliviano-sign mr-1"></i>{{ number_format($maquinaria->precio_dia, 2) }}/día
                        </h3>
                    </div>
                @else
                ...
                @auth
                    @if($maquinaria->precio_dia && $maquinaria->estadoMaquinaria && strtolower(str_replace(' ', '_', $maquinaria->estadoMaquinaria->nombre)) === 'disponible')
                    ...
                    @elseif($maquinaria->estadoMaquinaria && strtolower(str_replace(' ', '_', $maquinaria->estadoMaquinaria->nombre)) !== 'disponible')
                        <div class="alert alert-warning mb-0 py-3 text-center">
                            <i class="fas fa-exclamation-triangle fa-2x mb-2"></i>
                            <p class="mb-0"><strong>No disponible para alquiler</strong></p>
                            <small>Estado: {{ $maquinaria->estadoMaquinaria->nombre }}</small>
                        </div>
                    @endif
                @else
                    <div class="mt-3 pt-3 border-top">
                        <a href="{{ route('login') }}" class="btn btn-outline-success btn-modern btn-block">
                        ...
                        <div class="info-row-item">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <strong class="info-value">{{ \Carbon\Carbon::parse($maquinaria->created_at)->format('d/m/Y') }}</strong>
                                </div>
                            </div>
                        </div>
                    @else
            ...
            <div class="card seller-card mb-4">
                ...
                <div class="card-body">
                    <div class="info-row-item mb-3">
                        <h6 class="mb-2 font-weight-bold text-dark" style="font-size: 1.1rem;">{{ $maquinaria->user->name }}</h6>
                        <div class="d-flex align-items-center">
                            <i class="fas fa-envelope text-warning mr-2"></i>
                            <small class="text-muted info-value">{{ $maquinaria->user->email }}</small>
                        </div>
                    </div>
                            ...
                            <div class="info-row-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <strong class="info-value">{{ \Carbon\Carbon::parse($maquinaria->user->created_at)->format('d/m/Y') }}</strong>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    @auth
                        @if(auth()->id() !== $maquinaria->user_id)
                            <div class="mt-3 pt-3 border-top">
                                <a href="mailto:{{ $maquinaria->user->email }}" class="btn btn-warning btn-modern btn-block">
                    ...
                    @else
                        <div class="mt-3 pt-3 border-top">
                            <a href="{{ route('login') }}" class="btn btn-outline-warning btn-modern btn-block">
