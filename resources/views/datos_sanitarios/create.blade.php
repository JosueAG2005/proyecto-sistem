...
<div class="container-fluid px-3 px-md-4">
    ...
    <form action="{{ route('admin.datos-sanitarios.store') }}" method="POST" enctype="multipart/form-data" id="formDatosSanitarios">
        @csrf
                ...
                <div class="card-modern card-success mb-4">
                    ...
                    <div class="card-body-modern">
                        <div class="form-group-modern">
                            ...
                            <input type="text" name="vacuna" class="form-control-modern" placeholder="Ej: Triple, Brucelosis, etc. (opcional)">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="checkbox-modern-wrapper">
                                <div class="checkbox-modern">
                                    <input type="checkbox" class="checkbox-input" name="vacunado_fiebre_aftosa" id="vacunado_fiebre_aftosa" value="1">
                                ...
                                <div class="checkbox-modern">
                                    <input type="checkbox" class="checkbox-input" name="vacunado_antirabica" id="vacunado_antirabica" value="1">
                ...
                <div class="card-modern card-info mb-4">
                    ...
                    <div class="card-body-modern">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="tratamiento" class="form-control-modern" placeholder="Tipo de tratamiento aplicado">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="medicamento" class="form-control-modern" placeholder="Nombre del medicamento">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <input type="text" name="veterinario" class="form-control-modern" placeholder="Nombre del veterinario responsable">
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <textarea name="observaciones" class="form-control-modern" rows="4" placeholder="Notas adicionales sobre el tratamiento o estado del animal"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-modern card-primary mb-4">
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_campeon_raza" id="logro_campeon_raza" value="1" {{ old('logro_campeon_raza') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_campeon_raza">Campeón de Raza</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_gran_campeon_macho" id="logro_gran_campeon_macho" value="1" {{ old('logro_gran_campeon_macho') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_gran_campeon_macho">Gran Campeón Macho</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_gran_campeon_hembra" id="logro_gran_campeon_hembra" value="1" {{ old('logro_gran_campeon_hembra') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_gran_campeon_hembra">Gran Campeón Hembra</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_ubre" id="logro_mejor_ubre" value="1" {{ old('logro_mejor_ubre') ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_campeona_litros_dia" id="logro_campeona_litros_dia" value="1" {{ old('logro_campeona_litros_dia') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_campeona_litros_dia">Campeona en Litros/Día</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_lactancia" id="logro_mejor_lactancia" value="1" {{ old('logro_mejor_lactancia') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_lactancia">Mejor Lactancia</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_calidad_leche" id="logro_mejor_calidad_leche" value="1" {{ old('logro_mejor_calidad_leche') ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_novillo" id="logro_mejor_novillo" value="1" {{ old('logro_mejor_novillo') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_novillo">Mejor Novillo</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_gran_campeon_carne" id="logro_gran_campeon_carne" value="1" {{ old('logro_gran_campeon_carne') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_gran_campeon_carne">Gran Campeón de Carne</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_semental" id="logro_mejor_semental" value="1" {{ old('logro_mejor_semental') ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_madre" id="logro_mejor_madre" value="1" {{ old('logro_mejor_madre') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_madre">Mejor Madre</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_padre" id="logro_mejor_padre" value="1" {{ old('logro_mejor_padre') ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_padre">Mejor Padre</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_fertilidad" id="logro_mejor_fertilidad" value="1" {{ old('logro_mejor_fertilidad') ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section border-top-modern pt-4 mt-4">
                            ...
                            <div class="form-group-modern">
                                <label class="label-modern">
                                    <i class="fas fa-file-upload label-icon"></i> Subir Árbol Genealógico (PDF o Imagen)
                                </label>
                                <div class="file-upload-modern">
