        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div class="mb-3 mb-md-0">
                <h1 class="page-title">
                    ...
                    <span class="title-text">Editar Registro Sanitario</span>
                </h1>
                <p class="page-subtitle">Actualice la información del registro sanitario del animal</p>
            </div>
    ...
    <div class="info-card-modern mb-4">
        <div class="d-flex align-items-start">
            ...
            <div class="info-content">
                ...
                <p class="info-text mb-0">Puede actualizar los datos sanitarios de cualquier animal registrado en el sistema. 
                Los animales sin publicar aparecerán marcados con 
                <span class="badge badge-warning">[Sin publicar]</span>.</p>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.datos-sanitarios.update', $datoSanitario->id) }}" method="POST" enctype="multipart/form-data" id="formDatosSanitarios">
        @csrf
        @method('PUT')
                ...
                <div class="card-modern card-success mb-4">
                    ...
                    <div class="card-body-modern">
                        <div class="form-group-modern">
                            ...
                            <input type="text" name="vacuna" class="form-control-modern" value="{{ old('vacuna', $datoSanitario->vacuna ?? '') }}" placeholder="Ej: Triple, Brucelosis, etc. (opcional)">
                            <small class="form-text-modern">Especifique otras vacunas además de las marcadas abajo</small>
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="checkbox-modern-wrapper">
                                <div class="checkbox-modern">
                                    <input type="checkbox" class="checkbox-input" name="vacunado_fiebre_aftosa" id="vacunado_fiebre_aftosa" value="1" {{ old('vacunado_fiebre_aftosa', $datoSanitario->vacunado_fiebre_aftosa) ? 'checked' : '' }}>
                                ...
                                <div class="checkbox-modern">
                                    <input type="checkbox" class="checkbox-input" name="vacunado_antirabica" id="vacunado_antirabica" value="1" {{ old('vacunado_antirabica', $datoSanitario->vacunado_antirabica) ? 'checked' : '' }}>
                ...
                <div class="card-modern card-info mb-4">
                    ...
                    <div class="card-body-modern">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="tratamiento" class="form-control-modern" value="{{ old('tratamiento', $datoSanitario->tratamiento ?? '') }}" placeholder="Tipo de tratamiento aplicado">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="medicamento" class="form-control-modern" value="{{ old('medicamento', $datoSanitario->medicamento ?? '') }}" placeholder="Nombre del medicamento">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="date" name="fecha_aplicacion" class="form-control-modern" value="{{ old('fecha_aplicacion', $datoSanitario->fecha_aplicacion ?? '') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="date" name="proxima_fecha" class="form-control-modern" value="{{ old('proxima_fecha', $datoSanitario->proxima_fecha ?? '') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <input type="text" name="veterinario" class="form-control-modern" value="{{ old('veterinario', $datoSanitario->veterinario ?? '') }}" placeholder="Nombre del veterinario responsable">
                        </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <textarea name="observaciones" class="form-control-modern" rows="4" placeholder="Notas adicionales sobre el tratamiento o estado del animal">{{ old('observaciones', $datoSanitario->observaciones ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="file-upload-modern">
                                <input type="file" name="marca_ganado_foto" class="file-input-modern" id="marca_ganado_foto" accept="image/*">
                ...
                <div class="card-modern card-info mb-4">
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="form-group-modern">
                            ...
                            @endif
                            <div class="file-upload-modern">
                                <input type="file" name="carnet_dueño_foto" class="file-input-modern" id="carnet_dueño_foto" accept="image/*">
            ...
            <div class="col-lg-6">
                ...
                <div class="card-modern card-warning mb-4">
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="form-group-modern">
                            <label class="label-modern">
                                <i class="fas fa-file-image label-icon"></i> 
                                @if($datoSanitario->certificado_imagen)
                            ...
                            <div class="file-upload-modern">
                                <input type="file" name="certificado_imagen" class="file-input-modern" id="certificado_imagen" accept="image/*">
                ...
                <div class="card-modern card-warning mb-4">
                    ...
                    <div class="card-body-modern">
                        <div class="alert-modern alert-info-modern">
                            <i class="fas fa-info-circle"></i> 
                            <strong>Nota:</strong> Si el animal ha sido campeón en alguna competencia o exposición, puede subir aquí la imagen del certificado correspondiente.
                        </div>
                        ...
                        <div class="form-group-modern">
                            <label class="label-modern">
                                ...
                                @if($datoSanitario->certificado_campeon_imagen)
                                    Actualizar Imagen del Certificado de Campeón
                                @else
                                    Imagen del Certificado de Campeón
                                @endif
                            </label>
                            <div class="file-upload-modern">
                                <input type="file" name="certificado_campeon_imagen" class="file-input-modern" id="certificado_campeon_imagen" accept="image/*">
                                <label class="file-label-modern" for="certificado_campeon_imagen">
                                    ...
                                    <span class="file-text">
                                        @if($datoSanitario->certificado_campeon_imagen)
                                            Deje vacío para mantener la imagen actual o seleccione una nueva...
                                        @else
                                            Seleccione una imagen del certificado...
                                        @endif
                                    </span>
                                </label>
                            </div>
                ...
                <div class="card-modern card-primary mb-4">
                    ...
                    <div class="card-body-modern">
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_campeon_raza" id="logro_campeon_raza" value="1" {{ old('logro_campeon_raza', $datoSanitario->logro_campeon_raza) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_campeon_raza">Campeón de Raza</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_gran_campeon_macho" id="logro_gran_campeon_macho" value="1" {{ old('logro_gran_campeon_macho', $datoSanitario->logro_gran_campeon_macho) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_gran_campeon_macho">Gran Campeón Macho</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_gran_campeon_hembra" id="logro_gran_campeon_hembra" value="1" {{ old('logro_gran_campeon_hembra', $datoSanitario->logro_gran_campeon_hembra) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_gran_campeon_hembra">Gran Campeón Hembra</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_ubre" id="logro_mejor_ubre" value="1" {{ old('logro_mejor_ubre', $datoSanitario->logro_mejor_ubre) ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_campeona_litros_dia" id="logro_campeona_litros_dia" value="1" {{ old('logro_campeona_litros_dia', $datoSanitario->logro_campeona_litros_dia) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_campeona_litros_dia">Campeona en Litros/Día</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_lactancia" id="logro_mejor_lactancia" value="1" {{ old('logro_mejor_lactancia', $datoSanitario->logro_mejor_lactancia) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_lactancia">Mejor Lactancia</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_calidad_leche" id="logro_mejor_calidad_leche" value="1" {{ old('logro_mejor_calidad_leche', $datoSanitario->logro_mejor_calidad_leche) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_calidad_leche">Mejor Calidad de Leche</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_novillo" id="logro_mejor_novillo" value="1" {{ old('logro_mejor_novillo', $datoSanitario->logro_mejor_novillo) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_novillo">Mejor Novillo</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_gran_campeon_carne" id="logro_gran_campeon_carne" value="1" {{ old('logro_gran_campeon_carne', $datoSanitario->logro_gran_campeon_carne) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_gran_campeon_carne">Gran Campeón de Carne</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_semental" id="logro_mejor_semental" value="1" {{ old('logro_mejor_semental', $datoSanitario->logro_mejor_semental) ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section mb-4">
                            ...
                            <div class="switch-grid">
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_madre" id="logro_mejor_madre" value="1" {{ old('logro_mejor_madre', $datoSanitario->logro_mejor_madre) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_madre">Mejor Madre</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_padre" id="logro_mejor_padre" value="1" {{ old('logro_mejor_padre', $datoSanitario->logro_mejor_padre) ? 'checked' : '' }}>
                                    <label class="switch-label" for="logro_mejor_padre">Mejor Padre</label>
                                </div>
                                <div class="switch-modern">
                                    <input type="checkbox" class="switch-input" name="logro_mejor_fertilidad" id="logro_mejor_fertilidad" value="1" {{ old('logro_mejor_fertilidad', $datoSanitario->logro_mejor_fertilidad) ? 'checked' : '' }}>
                        ...
                        <div class="achievement-section border-top-modern pt-4 mt-4">
                            ...
                            @if($datoSanitario->arbol_genealogico)
                                <div class="mb-3 p-3 bg-light rounded">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="fas fa-file text-secondary fa-2x mr-3"></i>
                                        <div>
                                            <strong>Archivo Actual</strong>
                                            <p class="text-muted mb-0 small">
                                                <a href="{{ asset('storage/'.$datoSanitario->arbol_genealogico) }}" target="_blank" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-download"></i> Ver/Descargar Árbol Genealógico
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group-modern">
                                <label class="label-modern">
                                    ...
                                    @if($datoSanitario->arbol_genealogico)
                                        Actualizar Árbol Genealógico (PDF o Imagen)
                                    @else
                                        Subir Árbol Genealógico (PDF o Imagen)
                                    @endif
                                </label>
                                <div class="file-upload-modern">
                                    <input type="file" name="arbol_genealogico" class="file-input-modern" id="arbol_genealogico" accept=".pdf,.jpg,.jpeg,.png,.gif">
                                    <label class="file-label-modern" for="arbol_genealogico">
                                        <i class="fas fa-cloud-upload-alt"></i>
                                        <span class="file-text">
                                            @if($datoSanitario->arbol_genealogico)
                                                Deje vacío para mantener el archivo actual o seleccione uno nuevo...
                                            @else
                                                Seleccione un archivo PDF o imagen...
                                            @endif
                                        </span>
                                    </label>
                                </div>
                                <small class="form-text-modern">
                                    <i class="fas fa-info-circle"></i> Formatos permitidos: PDF, JPG, PNG, GIF. Tamaño máximo: 10MB
                                </small>
                            </div>
                        </div>
                    </div>
...
const fileInputs = [
    { id: 'certificado_imagen', icon: 'fa-file-image' },
    { id: 'marca_ganado_foto', icon: 'fa-file-image' },
    { id: 'carnet_dueño_foto', icon: 'fa-file-image' },
    { id: 'certificado_campeon_imagen', icon: 'fa-trophy' },
    { id: 'arbol_genealogico', icon: 'fa-file-upload' }
];
...
.achievement-primary { color: var(--primary-color); border-bottom-color: var(--primary-color); }
.achievement-success { color: var(--success-color); border-bottom-color: var(--success-color); }
.achievement-warning { color: var(--warning-color); border-bottom-color: var(--warning-color); }
.achievement-info { color: var(--info-color); border-bottom-color: var(--info-color); }
.achievement-secondary { color: var(--secondary-color); border-bottom-color: var(--secondary-color); }
