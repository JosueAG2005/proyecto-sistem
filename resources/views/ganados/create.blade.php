                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control" rows="4" placeholder="Describa las características del animal...">{{ old('descripcion') }}</textarea>
                        </div>
                    </div>
                </div>
