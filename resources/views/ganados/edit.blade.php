                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="edad_meses" 
                                               class="form-control text-center" 
                                               value="{{ old('edad_meses', $mesesRestantes) }}" 
                                               min="0" 
                                               max="11" 
                                               required>
                                        <div class="input-group-append">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" 
                                       ...
                                       step="0.01" 
                                       min="0" 
                                       value="{{ old('peso_actual', $ganado->peso_actual) }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01" 
                                       min="0" 
                                       value="{{ old('precio', $ganado->precio) }}"
                                       placeholder="0.00">
                            </div>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control" rows="4" placeholder="Describa las características del animal...">{{ old('descripcion', $ganado->descripcion) }}</textarea>
                        </div>
                    </div>
                </div>
